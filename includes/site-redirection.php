...
add_filter( 'rest_request_before_callbacks', 'site_rest_request_before_callbacks', 10, 3 );

if ( ! function_exists( 'site_rest_request_before_callbacks' ) ) {
	/**
	 ...
	 */
	function site_rest_request_before_callbacks( $response, $handler, $request ) {
		...
		if ( 'Redirection_Api_Redirect::route_create' === $red_callable_name ) {
			site_log_redirection_add( $request );
		} elseif ( 'Redirection_Api_Redirect::route_update' === $red_callable_name ) {
			site_log_redirection_edit( $request );
...
if ( ! function_exists( 'site_log_redirection_add' ) ) {
	/**
	 * Log when a Redirection is added.
	 *
	 * @param WP_REST_Request $req Request.
	 */
	function site_log_redirection_add( $req ) {
...
if ( ! function_exists( 'site_log_redirection_edit' ) ) {
	/**
	 * Log when a Redirection is edit.
	 *
	 * @param WP_REST_Request $req Request.
	 */
	function site_log_redirection_edit( $req ) {
		$action_data = $req->get_param( 'action_data' );
...
if ( ! function_exists( 'site_log_group_add' ) ) {
	/**
	 * Log when a group is added.
	 *
	 * @param WP_REST_Request $req Request.
	 */
	function site_log_group_add( $req ) {
