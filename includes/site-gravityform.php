...
if ( ! function_exists( 'site_gforms_save_entry' ) ) {
	/**
	 ...
	 */
	function site_gforms_save_entry( $action_type, $result ) {
...
add_action( 'check_admin_referer', 'site_gforms_save_entry', 10, 2 );

if ( ! function_exists( 'site_gforms_duplicate_notify' ) ) {
	/**
	 ...
	 *                  2 if the nonce is valid and generated between 12-24 hours ago.
	 */
	function site_gforms_duplicate_notify( $action, $result ) {
...
add_action( 'check_admin_referer', 'site_gforms_duplicate_notify', 10, 2 );

if ( ! function_exists( 'site_gform_entry_created' ) ) {
	/**
	 ...
	 */
	function site_gform_entry_created( $lead, $form ) {
...
add_action( 'gform_entry_created', 'site_gform_entry_created', 20, 2 );

if ( ! function_exists( 'site_wp_ajax_gf_resend_notifications' ) ) {
	/**
	 * Fires when resend email notifications.
	 */
	function site_wp_ajax_gf_resend_notifications() {
...
add_action( 'wp_ajax_gf_resend_notifications', 'site_wp_ajax_gf_resend_notifications' );
...
if ( ! function_exists( 'site_garvity_form_updated_option' ) ) {
	/**
	 ...
	 */
	function site_garvity_form_updated_option( $option, $oldvalue = null, $_newvalue = null ) {
...
add_action( 'updated_option', 'site_garvity_form_updated_option', 20, 3 );
add_action( 'delete_option', 'site_garvity_form_updated_option', 20, 3 );
add_action( 'add_option', 'site_garvity_form_updated_option', 20, 3 );
...
if ( ! function_exists( 'site_ajax_rg_update_confirmation_active' ) ) {
	/**
	 * Fires when confirmation activated.
	 */
	function site_ajax_rg_update_confirmation_active() {
...
add_action( 'wp_ajax_rg_update_confirmation_active', 'site_ajax_rg_update_confirmation_active' );
...
if ( ! function_exists( 'site_garvity_form_licence_updated' ) ) {
	/**
	 * Fires when settings updated.
	 *
	 ...
	 * @param string $_newvalue New Value.
	 */
	function site_garvity_form_licence_updated( $option, $oldvalue, $_newvalue ) {
...
add_action( 'updated_option', 'site_garvity_form_licence_updated', 20, 3 );
