 ...
 */
add_action( 'dp_duplicate_post', 'site_duplicate_post', 100, 3 );
add_action( 'dp_duplicate_page', 'site_duplicate_post', 100, 3 );

if ( ! function_exists( 'site_duplicate_post' ) ) {
	/**
	 * Duplicate Post.
	 *
	 ...
	 */
	function site_duplicate_post( $new_post_id, $post, $status ) {
